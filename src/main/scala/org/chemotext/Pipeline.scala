...
class Pipeline (theSparkConf : SparkConf) extends Serializable {
  ...
  def init () : PipelineContext = {
    ...
    val ctdPath = sparkConf.get ("ctdPath")
    val sampleSize = sparkConf.get ("sampleSize")
     ...
     ** spark context.
     **********************************************************/
    new PipelineContext (sc, appHome, meshXML, null, null, articleRootPath, ctdPath, sampleSize)
  }
